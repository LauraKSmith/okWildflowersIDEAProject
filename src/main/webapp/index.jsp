...
<section id="bottom">
  ...
  <!-- <div id="calendar"><img src="img/calendar2.png" height="50%" width="50%"></div> -->
    ...
    top: 0; left: 0; width: 50%; height: 50%; border-width:0px; max-width:100%; overflow-y:auto;" width="30%" height="30%" src="https://interactive-img.com/view?id=23832&iframe=true"></iframe></div>
