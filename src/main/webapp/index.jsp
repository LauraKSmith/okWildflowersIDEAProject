...
<section id="bottom">
    ...
    <br>
    <p><strong>80%</strong> of the worlds plants require pollination by animals.             <strong>37%</strong> of the 20,000 bee species on earth are in decline.            <strong>90%</strong> of bees in some regions have disappeared over the past 15 years.</p>
    <!--80% https://www.fs.fed.us/wildflowers/pollinators/importance.shtml#:~:text=More%20than%20150%20food%20crops,than%20%2410%20billion%20per%20year.-->
    <br>
    <p></p>  <!--  37 % https://www.sierraclub.org/georgia/BEElieve -->
    <br>
    <p></p> <!--  90% https://www.natgeokids.com/za/discover/animals/insects/honey-bees/ -->
