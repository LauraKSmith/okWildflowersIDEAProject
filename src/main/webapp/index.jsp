...
<section id="bottom">
  ...
  <!-- <div id="calendar"><img src="img/calendar2.png" height="50%" width="50%"></div> -->
    ...
    top: 0; left: 0; width: 50%; height: 50%; border-width:0px; overflow-y:visible;" width="100%" height="100%" src="https://interactive-img.com/view?id=23832&iframe=true"></iframe></div>
